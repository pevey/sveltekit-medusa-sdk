 ...
 */
export function parseSetCookieSession(setCookieHeaders: string[], backendSessionCookie: string, now: number): ParsedSession | null {
...
export function buildSessionHeader(sessionValue: string | undefined, backendSessionCookie: string): Record<string, string> {
